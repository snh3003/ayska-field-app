...
import type { ReportsResponse } from '../../src/types/api';
...
describe('ReportService', () => {
  ...
  it('gets reports successfully', async () => {
    ...
    mock.onGet('/api/reports', { params: { start: '2025-01-01', end: '2025-01-31' } } as any).reply(200, data);
  ...
  it('propagates errors', async () => {
    ...
    await expect(service.getReports('2025-01-01', '2025-01-31')).rejects.toBeTruthy();
  });
});
